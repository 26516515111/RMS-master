...
#include "../../../../studywork/practice/supermanager/RMS-master/cpp-qt-manageSystem-master/logindia.h"
...
constexpr auto qt_meta_stringdata_CLASSLoginDiaENDCLASS = QtMocHelpers::stringData(
    "LoginDia",
    "on_okBtn_released",
    "",
    "on_cancelBtn_released",
    "on_chPwdEdit_released",
    "on_aboutBtn_released"
);
...
Q_CONSTINIT const QMetaObject LoginDia::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginDiaENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_chPwdEdit_released'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_aboutBtn_released'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void LoginDia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_chPwdEdit_released(); break;
        case 3: _t->on_aboutBtn_released(); break;
        default: ;
        }
    }
    (void)_a;
